...
def basic_throughput_test():
    ...
    out = []
    single_basic = MLFQueue(num_lvls=5, batch_size=5, init_load=10.0)
    ...
    batch_basic = MLFQueue(num_lvls=5, batch_size=5, init_load=10.0)
    packet_list = []
...
def crash_test():
    return [MLFQueue(num_lvls=5, batch_size=32, init_load=10.0), 1, 1]

OUTPUT_TEST_INPUTS += basic_throughput_test()
