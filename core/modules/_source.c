...
/*
	static const std::vector<struct Command> cmds = {
		...
		{"set_burst", 	 (CmdFunc)&Source::command_set_burst, 	 1},
	};
*/
...
ModuleClassRegister<Source> source("Source", "source",
		"infinitely generates packets with uninitialized data");

//ADD_MODULE(Source, "source", "infinitely generates packets with uninitialized data", cmds)
