...
inline int wm_keycmp(const void *key, const void *key_stored, size_t key_len) {
...
inline uint32_t wm_hash(const void *key, uint32_t key_len, uint32_t init_val) {
