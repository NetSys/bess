...
class HashLB : public Module {
 ...
 private:
  void LbL2(struct bess::pkt_batch *batch, gate_idx_t *ogates);
  void LbL3(struct bess::pkt_batch *batch, gate_idx_t *ogates);
  void LbL4(struct bess::pkt_batch *batch, gate_idx_t *ogates);
