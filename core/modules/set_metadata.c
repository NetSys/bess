...
static void copy_from_packet(struct pkt_batch *batch, const struct attr *attr,
                             mt_offset_t mt_off) {
  int cnt = batch->cnt;
  int size = attr->size;
...
static void copy_from_value(struct pkt_batch *batch, const struct attr *attr,
                            mt_offset_t mt_off) {
  int cnt = batch->cnt;
  int size = attr->size;
...
static void set_metadata_process_batch(struct module *m,
